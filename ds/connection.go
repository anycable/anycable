...
// Connection represents a Durable Streams SSE connection wrapper
...
// NewConnection creates a new Durable Streams connection wrapper
...
// Established marks the connection as established and flushes any backlog
