...
func BenchmarkEncodersDecode(b *testing.B) {
	...
	configs := []struct {
		...
		{"Apollo base", baseApolloMsg, graphql.Encoder{}},
		{"Apollo long", longApolloMsg, graphql.Encoder{}},
...
func BenchmarkEncodersEncode(b *testing.B) {
	...
	configs := []struct {
		...
		{"Apollo base", &baseReply, graphql.Encoder{}},
		{"Apollo long", &longReply, graphql.Encoder{}},
...
func BenchmarkEncodersEncodeTransmission(b *testing.B) {
	...
	configs := []struct {
		...
		{"Apollo base", baseJSONReply, graphql.Encoder{}},
		{"Apollo long", longJSONReply, graphql.Encoder{}},
