...
func (_m *Broker) HandleBroadcast(msg *common.StreamMessage) error {
	ret := _m.Called(msg)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*common.StreamMessage) error); ok {
		r0 = rf(msg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Broker) HandleCommand(msg *common.RemoteCommandMessage) error {
	ret := _m.Called(msg)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*common.RemoteCommandMessage) error); ok {
		r0 = rf(msg)
	} else {
		r0 = ret.Error(0)
	}
